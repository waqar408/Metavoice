...
public class HeaderDolmetcherActivity extends AppCompatActivity {
    Button btn_save;
    EditText ed_1_header_dezimal,ed_2_header_dezimal,ed_3_header_dezimal,
            ed_4_header_dezimal,ed_5_header_dezimal, ed_6_header_dezimal,
            ed_7_header_dezimal,ed_8_header_dezimal,ed_9_header_dezimal,
            ed_10_header_dezimal,ed_11_header_dezimal,ed_12_header_dezimal,
            ed_13_header_dezimal,ed_14_header_dezimal,ed_15_header_dezimal,
            ed_16_header_dezimal,tv17, tv18;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_header_dolmetcher);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String ed_17_header_dezima = tv17.getText().toString();
                String ed18 = tv18.getText().toString();
                SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(HeaderDolmetcherActivity.this);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("79",ed_1_header_dezima);
                editor.putString("80",ed_2_header_dezima);
                editor.putString("81",ed_3_header_dezima);
                editor.putString("82",ed_4_header_dezima);
                editor.putString("83",ed_5_header_dezima);
                editor.putString("84",ed_6_header_dezima);
                editor.putString("85",ed_7_header_dezima);
                editor.putString("86",ed_8_header_dezima);
                editor.putString("87",ed_9_header_dezima);
                editor.putString("88",ed_10_header_dezima);
                editor.putString("89",ed_11_header_dezima);
                editor.putString("90",ed_12_header_dezima);
                editor.putString("91",ed_13_header_dezima);
                editor.putString("92",ed_14_header_dezima);
                editor.putString("93",ed_15_header_dezima);
                editor.putString("94",ed_16_header_dezima);
                editor.putString("95",ed_17_header_dezima);
                editor.apply();
