...
public class FooterDezimalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_footer_dezimal);
        ...
        String st1 = preferences.getString("137","Metaphrase");
        String st2 = preferences.getString("138", "Beste Sprachschule in Tunesien für Deutsch &amp; weitere Sprachen und zur Unterstützung von Immigrationsangelegenheiten");
        String st3 = preferences.getString("139"," 63065 Offenbach am Main");
        String st4 = preferences.getString("140","Tel: 069 506 086 810");
        String st5 = preferences.getString("141","Fax: (069) 900 19 595");
        String st6 = preferences.getString("142","service@metaphrase.net");
        String st7 = preferences.getString("143","www.metaphrase.online");
        String st8 = preferences.getString("144","Metaphrase");
        String st9 = preferences.getString("145","DE95 1101 0101 5518 4742 83");
        String st10 = preferences.getString("146","Steuernummer:354021229");
        String st11 = preferences.getString("147","Finanzamt Offenbach");
        String st12 = preferences.getString("148","BIC: SOBKDEB2XXX");
        ...
        btn_saveFooter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(FooterDezimalActivity.this);
                SharedPreferences.Editor editor = preferences.edit();
                editor.putString("137",ed_1_footer_dezima);
                editor.putString("138",ed_2_footer_dezima);
                editor.putString("139",ed_3_footer_dezima);
                editor.putString("140",ed_4_footer_dezima);
                editor.putString("141",ed_5_footer_dezima);
                editor.putString("142",ed_6_footer_dezima);
                editor.putString("143",ed_7_footer_dezima);
                editor.putString("144",ed_8_footer_dezima);
                editor.putString("145",ed_9_footer_dezima);
                editor.putString("146",ed_10_footer_dezima);
                editor.putString("147",ed_11_footer_dezima);
                editor.putString("148",ed_rest);
                editor.apply();
