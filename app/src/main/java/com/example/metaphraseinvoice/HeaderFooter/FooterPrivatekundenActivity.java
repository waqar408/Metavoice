...
public class FooterPrivatekundenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_footer_privatekunden);
        ...
        String st1 = preferences.getString("125","Metaphrase");
        String st2 = preferences.getString("126","Beste Sprachschule in Tunesien für Deutsch &amp; weitere Sprachen und zur Unterstützung von Immigrationsangelegenheiten");
        String st3 = preferences.getString("127","63065 Offenbach am Main");
        String st4 = preferences.getString("128","Tel: 069 506 086 810");
        String st5 = preferences.getString("129","Fax: (069) 900 19 595");
        String st6 = preferences.getString("130","service@metaphrase.net");
        String st7 = preferences.getString("131","www.metaphrase.online");
        String st8 = preferences.getString("132","Metaphrase");
        String st9 = preferences.getString("133","DE95 1101 0101 5518 4742 83");
        String st10 = preferences.getString("134","Steuernummer:354021229");
        String st11 = preferences.getString("135","Finanzamt Offenbach");
        String st12 = preferences.getString("136","BIC: SOBKDEB2XXX");
        ...
        btn_saveFooter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(FooterPrivatekundenActivity.this);
                SharedPreferences.Editor editor = preferences.edit();
                editor.putString("125",ed_1_footer_dezima);
                editor.putString("126",ed_2_footer_dezima);
                editor.putString("127",ed_3_footer_dezima);
                editor.putString("128",ed_4_footer_dezima);
                editor.putString("129",ed_5_footer_dezima);
                editor.putString("130",ed_6_footer_dezima);
                editor.putString("131",ed_7_footer_dezima);
                editor.putString("132",ed_8_footer_dezima);
                editor.putString("133",ed_9_footer_dezima);
                editor.putString("134",ed_10_footer_dezima);
                editor.putString("135",ed_11_footer_dezima);
                editor.putString("136",ed_rest);
                editor.apply();
