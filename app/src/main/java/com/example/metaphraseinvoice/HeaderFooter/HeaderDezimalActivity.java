...
public class HeaderDezimalActivity extends AppCompatActivity {
    Button btn_save;
    ...
    ,ed_17_header_dezimal, tv17, tv18;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_header_dezimal);
        ...
        tv18 = findViewById(R.id.tv18);        //to retreive data from shared prefrence
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(HeaderDezimalActivity.this);
                SharedPreferences.Editor editor = sharedPreferences.edit();
                editor.putString("62",ed_1_header_dezima);
                editor.putString("63",ed_2_header_dezima);
                editor.putString("64",ed_3_header_dezima);
                editor.putString("65",ed_4_header_dezima);
                editor.putString("66",ed_5_header_dezima);
                editor.putString("67",ed_6_header_dezima);
                editor.putString("68",ed_7_header_dezima);
                editor.putString("69",ed_8_header_dezima);
                editor.putString("70",ed_9_header_dezima);
                editor.putString("71",ed_10_header_dezima);
                editor.putString("72",ed_11_header_dezima);
                editor.putString("73",ed_12_header_dezima);
                editor.putString("74",ed_13_header_dezima);
                editor.putString("75",ed_14_header_dezima);
                editor.putString("76",ed_15_header_dezima);
                editor.putString("77",ed_16_header_dezima);
                editor.putString("78",ed_17_header_dezima);
                editor.putString("200",ed18);
                editor.apply();
