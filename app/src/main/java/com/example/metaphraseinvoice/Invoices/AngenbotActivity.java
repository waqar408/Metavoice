...
import com.example.metaphraseinvoice.HeaderFooter.FooterAngebotActivity;
import com.example.metaphraseinvoice.HeaderFooter.HeaderAngebotActivity;
...
public class AngenbotActivity extends AppCompatActivity {
    Button btn_editheader_Angebot, btn_editfooter_angebot;
    TextView tv_1sehgehtre, ed_2denAn, tv_3_Dplmetscherauftrag, tv_4_berechnen, tv_5_metaphrase,
            tv_6_drname, tv_7_VerWend, tv_8_Dolmetscherund, tv_9_Weutenberger, tv_10_0319_W1228,
            tv_11_GroB, tv_12_AstafflenbergesterBe, tv_13_datum, tv_14_offenbach212, tv_15_stutgrat23,
            tv_16_date, tv_18_metaphrase_footer, tv_19_GroB_footer,
            tv_20_offenbench34_footer, tv_21_tel_footer, tv_22_fax_footer, tv_23_mail_footer,
            tv_24_metaphrase_mail_footer, tv_25_Velksbank_footer, tv_26_banknumber_footer,
            tv_27_Steuernumner_footer, tv_28_finnazami_footer,
            tv_newdialog, tv17, tv18;


    //TODO:Table items views
    ...
    TextView tv_netto, tv_19_perc, tv_grand_total;
    EditText tv_advance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_angenbot);
        ...
        //diolog boc
        tv_newdialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(AngenbotActivity.this);
                dialog.setContentView(R.layout.ed_dialogbox);
                dialog.setTitle("Title...");
                Window window = dialog.getWindow();
                window.setGravity(Gravity.CENTER);
                window.setLayout(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                tv_newdialog.getText().toString();
        ...
        //TODO:CLICKS
        btn_editheader_Angebot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AngenbotActivity.this, HeaderAngebotActivity.class);
                startActivityForResult(intent, 3);
            }
        });
        btn_editfooter_angebot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AngenbotActivity.this, FooterAngebotActivity.class);
        ...
        btn_save_as_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (isSaved) {
                    Toast.makeText(AngenbotActivity.this, "\n" +
                            "Bereits gespeichert", Toast.LENGTH_SHORT).show();
                } else {
                    btn_editfooter_angebot.setVisibility(View.GONE);
                    btn_editheader_Angebot.setVisibility(View.GONE);
                    layoutToImage(v);
                }
            }
        });
    ...
    private void fillTable(ArrayList<ItemModel> itemModelArrayList) {
        ...
        if (itemModelArrayList.size() == 1) {
            ...
            SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(AngenbotActivity.this);
            double total1 = quantity1 * price1;
            tv_Betrag_1.setText(total1 + "");
            netto = total1;
            SharedPreferences.Editor editor = preferences.edit();
            editor.putString("1", String.valueOf(price1));
            editor.apply();
    ...
    private void inItComponents() {
        ...
        btn_editheader_Angebot = findViewById(R.id.btn_editheader_Angebot);
        btn_editfooter_angebot = findViewById(R.id.btn_editfooter_angebot);
        ...
        tv_newdialog = findViewById(R.id.tv_newdialog);
        //ids for footer
    ...
    public void layoutToImage(View view) {
        ...
        try {
            ...
            Log.d("sss", "layoutToImage: " + e.getLocalizedMessage());
            e.printStackTrace();
        }
    }
    ...
    public void imageToPDF() throws FileNotFoundException {
        try {
            ...
            Toast.makeText(AngenbotActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            Log.d("sss", "imageToPDF: " + e.getStackTrace());
        }
    }
    ...
    private void viewPdf() {
        if (fileUri.exists()) //Checking if the file exists or not
        {
            ...
            try {
                ...
                Toast.makeText(AngenbotActivity.this, "Can't read pdf file", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(AngenbotActivity.this, "File not exist!", Toast.LENGTH_SHORT).show();
        }
    }
