...
import com.example.metaphraseinvoice.HeaderFooter.FooterPrivatekundenActivity;
import com.example.metaphraseinvoice.HeaderFooter.HeaderPrivatekundenAvtivity;
...
public class PrivatkundenRechnung extends AppCompatActivity {
    TextView tv_rest,tv_1sehgehtre, ed_2denAn, tv_3_Dplmetscherauftrag, tv_4_berechnen,
            tv_5_metaphrase, tv_6_drname, tv_7_VerWend, tv_8_Dolmetscherund,
            tv_9_Weutenberger, tv_10_0319_W1228, tv_11_GroB, tv_12_AstafflenbergesterBe,
            tv_13_datum, tv_14_offenbach212, tv_15_stutgrat23, tv_16_date,
            tv_17_abzahlungseingang, tv_18_metaphrase_footer, tv_19_GroB_footer,
            tv_20_offenbench34_footer, tv_21_tel_footer, tv_22_fax_footer,
            tv_23_mail_footer, tv_24_metaphrase_mail_footer, tv_25_Velksbank_footer,
            tv_26_banknumber_footer, tv_27_Steuernumner_footer, tv_28_finnazami_footer,tv17,tv18;
    Context context = this;
    Button btn_editheader_priavte;
    Button btn_editfooter_private;
    ...
    TextView tv_netto,tv_19_perc,tv_grand_total,newprivtext;
    EditText tv_advance;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_privatkunden_rechnung);
        ...
        inItComponents();
        newprivtext = findViewById(R.id.newprivtext);
        newprivtext.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = new Dialog(PrivatkundenRechnung.this);
                dialog.setContentView(R.layout.ed_dialogbox4);
                dialog.setTitle("Title...");
                Window window = dialog.getWindow();
                window.setGravity(Gravity.CENTER);
                window.setLayout(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
                newprivtext.getText().toString();
        ...
        btn_editfooter_private.setVisibility(View.VISIBLE);
        fillTable(itemModelArrayList);

        //TODO:CLICKS
        btn_editheader_priavte.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PrivatkundenRechnung.this, HeaderPrivatekundenAvtivity.class);
                startActivityForResult(intent,5);
            }
        });
        btn_editfooter_private.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PrivatkundenRechnung.this, FooterPrivatekundenActivity.class);
        ...
        btn_save_as_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isSaved){
                    ...
                    btn_editfooter_private.setVisibility(View.GONE);
                    btn_editheader_priavte.setVisibility(View.GONE);
                    layoutToImage(v);
                }
    ...
    private void inItComponents() {
        ...
        btn_editfooter_private = findViewById(R.id.btn_editfooter_private);
        btn_editheader_priavte = findViewById(R.id.btn_editheader_Angebot);
   ...
   /* Bitmap bm = rl_invoice.getDrawingCache();
    ...
    public void imageToPDF() throws FileNotFoundException {
        try {
            ...
            Toast.makeText(PrivatkundenRechnung.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            Log.d("sss", "imageToPDF: " + e.getMessage());
        }
    }
    /**
    ...
    private void viewPdf() {
        if (fileUri.exists()) //Checking if the file exists or not
        {
            ...
            try {
                ...
                Toast.makeText(PrivatkundenRechnung.this, "Can't read pdf file", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(PrivatkundenRechnung.this, "File not exist!", Toast.LENGTH_SHORT).show();
        }
    }
